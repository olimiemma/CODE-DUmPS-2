...
#------------------------K MEANS------------------------------------------------------------
"""If you dont know how to choose K, you cna run hierachicla clustering on a small subsee iof the data and get an idea and use that K in K means clustering"""
...
#---------------------------- Initial CENTROIDS locations-----------------------------
centers = [(2, 3), (4, 6), (7, 4), (7,7)] # choosing initial centroids
examples = []
random.seed(0)
for c in centers:
    for i in range(5):
...
random.seed(0)
kmeans(examples, 4, True)   # choosing K